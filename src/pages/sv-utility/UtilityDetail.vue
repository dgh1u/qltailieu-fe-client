  ...
  <DefaultLayout>
    ...
    >
      <div class="text-sm text-gray-500 flex items-center flex-wrap space-x-1">
        <router-link to="/post/utility" class="text-sky-500 hover:underline">
          Tiện ích
        </router-link>
        <span>/</span>
    ...
    <!-- Cấu trúc trang chia làm 2 cột - Responsive -->
    <div class="flex min-h-screen flex-col lg:flex-row">
        ...
        <div v-else-if="post" class="pt-4">
          <div class="bg-white rounded-xl p-4 text-left shadow-lg">
            <div>
              ...
              <!-- Danh sách đặc điểm - Responsive Grid -->
              <div class="py-2">
      ...
      <!-- Cột phải: Thông tin người đăng - Responsive -->
